...
* [toad.js](https://github.com/markandre13/toad.js) lightweight presentation and application layer gui toolkit for web applications
...
* [usd.js](https://github.com/markandre13/usd.js) tiny, dependency-free USDC library written in TypeScript
* [async.cc](https://github.com/markandre13/async.cc) an [async/await style](https://en.wikipedia.org/wiki/Async/await) c++ coroutine class for corba.cc
